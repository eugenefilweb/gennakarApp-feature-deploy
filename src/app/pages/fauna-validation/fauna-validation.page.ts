...
@Component({
  selector: 'app-fauna-validation',
  templateUrl: './fauna-validation.page.html',
  styleUrls: ['./fauna-validation.page.scss'],
})
export class FaunaValidationPage implements OnInit {
  fauna: LiveFauna[] = [];
	...
	generateFaunaValidationName(faunaId: any): string {
